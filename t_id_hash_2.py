...
#message_text_3_2 = '\n\nThe game takes 12-15 minutes including wait time.  You get $2 for participating, and up to $2 extra for correct answers. All payments will be submitted via bonus to your Kellogg eLab enrollment HIT.\n\n˗ˏˋ HOW IT WORKS ˊˎ˗‏\n\nThe game starts at exactly 5:00pm ET (2:00pm PT)\n\nClick the link above to enter.\n\nThis link will *close* at exactly 5:00pm ET (2:00pm PT). You must enter before 5:00pm ET (2:00pm PT) to participate.\n\nIf you arrive early, you\'ll be shown a countdown to start time.\n\nAfter the link closes at 5:00pm ET (2:00pm PT), there will be up to 1 minute additional wait time to ensure everyone is synchronized.\n\nThe game itself takes less than 15 minutes.'
...
# POLITICS CHALLENGE
#message_subject_3 = '[Real Time Labs] It\'s time for The Politics Challenge! Earn up to $3.10 in less than 15 minutes.'

#message_text_3_1 = 'It\'s time for The Politics Challenge! Earn up to $3.10 in less than 15 minutes.\n\nWe have limited space, so click the link early to reserve your spot!\n\nClick the link to play:\n\n'
#message_text_3_2 = '\n\nThe game takes 12-15 minutes including wait time.  You get $1.50 for participating, and up to $1.60 extra for correct answers. All payments will be submitted via bonus to your Kellogg eLab enrollment HIT.\n\n˗ˏˋ HOW IT WORKS ˊˎ˗‏\n\nThe game starts at exactly 4:30pm ET (1:30pm PT)\n\nClick the link above to enter.\n\nThis link will *close* at exactly 4:30pm ET (1:30pm PT). You must enter before 4:30pm ET (1:30pm PT) to participate.\n\nIf you arrive early, you\'ll be shown a countdown to start time.\n\nAfter the link closes at 4:30pm ET (1:30pm PT), there will be up to 1 minute additional wait time to ensure everyone is synchronized.\n\nThe game itself takes less than 15 minutes.'

# BONUS ROUND
#message_subject_3 = '[Real Time Labs] STARTING NOW - Politics Challenge Bonus Round!'

#message_text_3_1 = 'We\'ve got another chance for you to complete the Politics Challenge! Earn up to $3.10 in less than 15 minutes.\n\nWe have limited space, so click the link early to reserve your spot!\n\nClick the link to play:\n\n'
#message_text_3_2 = '\n\nThe game takes 12-15 minutes including wait time.  You get $1.50 for participating, and up to $1.60 extra for correct answers. All payments will be submitted via bonus to your Kellogg eLab enrollment HIT.\n\n˗ˏˋ HOW IT WORKS ˊˎ˗‏\n\nThe game starts at exactly 5:00pm ET (2:00pm PT)\n\nClick the link above to enter.\n\nThis link will *close* at exactly 5:00pm ET (2:00pm PT). You must enter before 5:00pm ET (2:00pm PT) to participate.\n\nIf you arrive early, you\'ll be shown a countdown to start time.\n\nAfter the link closes at 5:00pm ET (2:00pm PT), there will be up to 1 minute additional wait time to ensure everyone is synchronized.\n\nThe game itself takes less than 15 minutes.'

# BONUS ROUND SPECIAL
#message_subject_3 = '[Real Time Labs] STARTING NOW - Politics Challenge Bonus Round!'

#message_text_3_1 = 'Thank you for your interest in the Politics Challenge! We know some of you had issues with not getting assigned to a game. Great news: from now on, everybody who enters the game system gets to play! In order to make this possible, we\'re limiting this activity to 80 spots, so click the link early!\n\nMore great news:  we\'re doing a bonus round today!  This task will start at 5:00pm ET, but might fill up before then.\n\nClick the link to play:\n\n'
#message_text_3_2 = '\n\nThe game takes 12-15 minutes including wait time.  You get $1.50 for participating, and up to $1.60 extra for correct answers. All payments will be submitted via bonus to your Kellogg eLab enrollment HIT.\n\n˗ˏˋ HOW IT WORKS ˊˎ˗‏\n\nThe game starts at exactly 5:00pm ET (2:00pm PT)\n\nClick the link above to enter.\n\nThis link will *close* at exactly 5:00pm ET (2:00pm PT). You must enter before 5:00pm ET (2:00pm PT) to participate.\n\nIf you arrive early, you\'ll be shown a countdown to start time.\n\nAfter the link closes at 5:00pm ET (2:00pm PT), there will be up to 1 minute additional wait time to ensure everyone is synchronized.\n\nThe game itself takes less than 15 minutes.'
...
def main():
	...
	s = pd.read_csv('sample_11802E_051619_1.csv', header = 0)
	ids = s.loc[:,'MID']
	workers = ids.tolist()
